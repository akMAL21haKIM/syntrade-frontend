...
const Tooltip = ({ msg = " A left aligned tooltip.", children }) => {
  return (
    <div class="relative flex justify-center align-center group w-full">
      <div class="absolute flex flex-col z-99 top-0 items-center hidden group-hover:-top-[3rem] group-hover:flex">
        <span class="flex z-10 p-2 -left-10 text-xs leading-none text-white bg-black shadow-lg">
          {msg}
        </span>
        <div class="absolute -bottom-[0.4rem] w-3 h-3 -ml-2 rotate-45 bg-black hover:-top-2"></div>
      </div>
      {children}
    </div>
  );
