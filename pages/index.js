    ...
    <div className="flex bg-white font-sans text-gray-900">
      ...
      <aside className="absolute inset-y-0 right-0 h-screen w-[300px] flex flex-col bg-gray-200 border-l border-gray-200">
        ...
        <div className="static h-36 w-38 m-6 bg-white rounded-md">
          ...
          <div className="flex flex-row h-10 w-3/4 mt-7 ml-8">
            {/* Minutes text */}
            <div className="flex h-10 w-1/2 relative rounded-tl-md rounded-bl-md bg-transparent bg-gray-300 border-r border-gray-400">
              <span className="m-auto text-l font-thin">Minutes</span>
            </div>
            {/* time-number counter */}
            <div className="flex h-10 w-1/2 rounded-lg relative bg-transparent rounded-tr-md rounded-br-md">
              <button
              ...
              <button
                ...
                className="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 cursor-pointer rounded-tr-md rounded-br"
              >
      ...
      {/* footer */}
      <div class="absolute h-10 text-center p-2 bg-gray-200 inset-x-0 bottom-0">
        <span className="font-semibold">
          © 2022 Syntrade. All rights reserved.
        </span>
      </div>
    </div>
  );
